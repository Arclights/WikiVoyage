 ...
 * {@link DestinationListActivity}.
 * <p/>
 * This activity is mostly just a 'shell' activity containing nothing more than
 * a {@link DestinationDetailFragment}.
 */
public class DestinationDetailActivity extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState == null) {
            ...
            pageName = getIntent().getExtras().getString(DestinationListActivity.DETAIL_PAGE_NAME);
            Section section = getIntent().getParcelableExtra(
                    DestinationDetailFragment.ARG_SECTION);
            setTitle(section.header.toString());
            ...
            getSupportFragmentManager().beginTransaction()
                    .add(R.id.section_detail_container, fragment).commit();
        }
    }
